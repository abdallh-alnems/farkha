          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                _consumptionRow('يومي', dailyFeedG < 1000 ? '$dailyFeedG' : '${(dailyFeedG / 1000).round()}', dailyFeedG < 1000 ? 'جرام' : 'كيلو', accentColor),
                SizedBox(height: 8.h),
                _consumptionRow('حتى الآن', '${consumedSoFar.toStringAsFixed(0)}', 'كيلو', accentColor),
                SizedBox(height: 8.h),
                _consumptionRow('الكلي', totalFeed < 1000 ? '${totalFeed.round()}' : '${(totalFeed / 1000).toStringAsFixed(1)}', totalFeed < 1000 ? 'كيلو' : 'طن', accentColor),
              ],
            ),
          ),
        ),
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 12.h),
                _consumptionRow('يومي', dailyWaterMl < 1000 ? '$dailyWaterMl' : '${(dailyWaterMl / 1000).round()}', dailyWaterMl < 1000 ? 'مل' : 'لتر', const Color(0xFF5B8A7A)),
                SizedBox(height: 8.h),
                _consumptionRow(
                  'تراكمي',
                  totalWater < 1 ? '${(totalWater * 1000).round()}' : totalWater < 1000 ? '${totalWater.toStringAsFixed(1)}' : '${(totalWater / 1000).toStringAsFixed(1)}',
