    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          Column(
            children: [
              Text("العدد", style: Theme.of(context).textTheme.displayMedium),
              _divider(),
              Text(
          ...
          Column(
            children: [
              Text("العمر", style: Theme.of(context).textTheme.displayMedium),
              _divider(),
              Text(
          ...
          Column(
            children: [
              Text("المساحة", style: Theme.of(context).textTheme.displayMedium),
              _divider(),
              Text(
                "${controller.requiredArea.toStringAsFixed(0)}م²",
                style: Theme.of(context).textTheme.displayMedium,
              ),
            ],
          ),
