...
import '../../../logic/controller/calculate_controller/temperature_by_age_controller.dart';
import '../../../core/constant/routes/route.dart';
import '../../../core/shared/input_fields/age_dropdown.dart';

class TemperatureByAgeScreen extends StatefulWidget {
  TemperatureByAgeScreen({super.key});
...
class _TemperatureByAgeScreenState extends State<TemperatureByAgeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(text: 'درجة الحرارة حسب العمر'),
      body: SafeArea(
