...
class CycleSalesScreen extends StatelessWidget {
    ...
    return Scaffold(
      body: CustomScrollView(
        ...
        slivers: [
          ...
          SliverToBoxAdapter(
            child: _buildSummarySection(context, salesCtrl, isDark),
          ),
          SliverToBoxAdapter(
            child: Padding(
          ...
          _buildSalesSliverList(salesCtrl, isDark, colorScheme),
          SliverToBoxAdapter(
  ...
  Widget _buildSummarySection(BuildContext context, CycleSalesController controller, bool isDark) {
    final colorScheme = Theme.of(context).colorScheme;
    ...
    return Obx(() {
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color: isDark ? Colors.black54 : colorScheme.primary.withValues(alpha: 0.4),
              blurRadius: 20,
  ...
  Widget _buildSalesSliverList(CycleSalesController controller, bool isDark, ColorScheme colorScheme) {
    return Obx(() {
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Icon(Icons.sell_outlined, size: 60.sp, color: colorScheme.onSurface.withValues(alpha: 0.3)),
                ),
                SizedBox(height: 20.h),
                Text(
                  'لا توجد عمليات بيع مسجلة بعد',
                  style: TextStyle(color: colorScheme.onSurface.withValues(alpha: 0.5), fontSize: 16.sp, fontWeight: FontWeight.w600),
                ),
              ],
            ),
          ),
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    _buildDetailItem('العدد', '${sale.birdsCount}', 'طائر', isDark, colorScheme),
                    _buildDetailItem('الوزن', sale.totalWeight.toStringAsFixed(0), 'كجم', isDark, colorScheme),
                    _buildDetailItem('السعر', sale.pricePerKilo.toStringAsFixed(0), 'جـ', isDark, colorScheme),
                  ],
                ),
              ],
            ),
  ...
  Widget _buildDetailItem(String label, String value, String unit, bool isDark, ColorScheme colorScheme) {
    return Row(
      children: [
        Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Row(
                  children: [
                    Container(
                      ...
                      child: Icon(Icons.add_shopping_cart, color: colorScheme.primary, size: 22.sp),
                    ),
                    SizedBox(width: 12.w),
                    Text(
                      'إضافة عملية بيع',
                ...
                SizedBox(height: 24.h),
                _buildTextField(birdsCountController, 'عدد الطيور', isDark, colorScheme, keyboardType: TextInputType.number),
                SizedBox(height: 16.h),
                _buildTextField(weightController, 'الوزن الكلي (كيلو)', isDark, colorScheme, keyboardType: TextInputType.number),
                SizedBox(height: 16.h),
                _buildTextField(priceController, 'سعر الكيلو اليوم', isDark, colorScheme, keyboardType: TextInputType.number),
                  ...
                  children: [
                    Expanded(
                      child: TextButton(
                        ...
                        child: Text(
                          AppStrings.cancel,
                          style: TextStyle(color: colorScheme.onSurface.withValues(alpha: 0.6), fontWeight: FontWeight.bold, fontSize: 16.sp),
                        ),
                      ),
                    ),
                    SizedBox(width: 12.w),
                      ...
                      child: Obx(() {
                        ...
                        return ElevatedButton(
                          ...
                          child: isLoading
                              ...
                              : Text('حفظ الإضافة', style: TextStyle(color: colorScheme.onPrimary, fontWeight: FontWeight.bold, fontSize: 16.sp)),
                        );
                      }),
                    ),
                  ],
  ...
  Widget _buildTextField(
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        hintText: hint,
        hintStyle: TextStyle(color: colorScheme.onSurface.withValues(alpha: 0.5), fontSize: 14.sp, fontWeight: FontWeight.normal),
        filled: true,
